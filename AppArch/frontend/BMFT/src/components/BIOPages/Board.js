...
const teamMembers = [
  {
    ...
    imgSrc: "http://example.com/elma.jpg" // Replace with actual link later
  },
  {
    name: "Sayuri Tzul",
    ...
    imgSrc: "http://example.com/sayuri.jpg" // Replace with actual link later
  },
  {
    name: "Lyndon Mai",
    ...
    imgSrc: "http://example.com/lyndon.jpg" // Replace with actual link later
  },
  {
    name: "Ermain Requena",
    ...
    imgSrc: "http://example.com/ermain.jpg" // Replace with actual link later
  },
  {
    name: "Raquel Chun",
    ...
    imgSrc: "http://example.com/raquel.jpg" // Replace with actual link later
  },
];
  ...
  return (
    <div>
      <header className={styles.header}>
        <img src="http://example.com/stop.jpg" alt="Header" className={styles.headerImage} /> {/* Replace with actual link */}
